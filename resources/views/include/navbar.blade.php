            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto navbar-display">
                    ...
                    @guest
                        ...
                        <li class="nav-item">
                            <a href="{{ route('login') }}" class="btn btn-primary nav-link px-4 text-white">Masuk</a>
                        </li>
                    @endguest
                ...
                @auth
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                @if (Auth::user()->roles === 'USER')
                                    <a href="{{ route('dashboard-history') }}" class="dropdown-item">Dashboard</a>
                                @endif
                    ...
                    <ul class="navbar-nav d-block d-lg-none">
                        <li class="nav-item">
                            <a href="{{ route('dashboard') }}" class="nav-link"> Hallo,{{ Auth::user()->name }} </a>
                        </li>
                        <li class="nav-item">
